...
& powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\start_project_stack.ps1
...
Write-Host '[workspace] Web and API are running in Docker containers.'
Write-Host '[workspace] A separate PowerShell window was opened for the desktop Python worker.'
